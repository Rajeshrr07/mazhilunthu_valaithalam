  ...
  return (
    <div className="pt-20 flex flex-col ">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-5xl md:text-8xl mb-4 gradient-title">
              Find your dream car with Mazhilunthu Valaithalam
            </h1>
      ...
      <section className="p-16">
        <div className="container mx-auro px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Thousands of verified vechicles from trusted dealership and
              provate sellers
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent rounded-lg flex items-end">
                    <h3 className="text-white text-md font-bold pl-4">
                      {type.name}
                    </h3>
                  </div>
                </Link>
      ...
      <section className="p-16 dotted-background text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">
            Ready to Find Your Dream Car?
          </h2>
          <p className="text-xl text-blue-100 mb-6 max-w-2xl mx-auto">Join thousands of satisfied customers who found their perfect vechicle through our platform</p>
